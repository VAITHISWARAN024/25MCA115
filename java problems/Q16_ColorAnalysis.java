	 ...
	 */
	    ...
	    public static void main(String[] args) {
	        ...
	        switch (colour) {
	            case 'r':
	            case 'R':
	                System.out.println("Color Code " + colour + " is RED");
	                break;
	            case 'g':
	            case 'G':
	                System.out.println("Color Code " + colour + " is GREEN");
	                break;
	            case 'b':
	            case 'B':
	                System.out.println("Color Code " + colour + " is BLUE");
	                break;
	            default:
	                System.out.println("Color Code " + colour + " is BLACK");
	        }
	    }
